...
#ENTER CODE BELOW HERE
after_point =  str(x)[ str(x).find(".") + 1 : str(x).find(".") + 2 ]
upper = after_point.find('5') + 1
upper = upper + after_point.find('6') + 1
upper = upper + after_point.find('7') + 1
upper = upper + after_point.find('8') + 1
upper = upper + after_point.find('9') + 1
x = x + upper
x = str(x)[: str(x).find(".") ]
print x
...
###
replace_position = line.find(marker)

replaced = line[ : replace_position] + replacement + line[ replace_position + len(marker) :]
